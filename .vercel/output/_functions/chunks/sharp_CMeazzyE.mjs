import { A as AstroError, v as MissingSharp } from './entrypoint_Cm6JRxTM.mjs';
import { b as baseService, p as parseQuality } from './generic_CjtMdf5L.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_D7IRxUpP.mjs').then(n => n.i)).default;
  } catch {
